...
double SimplexNoise(double xin, double yin, double zin) {
  ...
  // Calculate the contribution from the four corners, the 0.5 is changed from most
  // (all?) implementations i've seen (it was 0.6), as per recommendation in this pdf
  // by Stefan Gustavsen, the writer of the implementation this is based off:
